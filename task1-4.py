...
plt.ylabel("Value")
plt.legend()
plt.savefig("pics/prediction/noisy_sine_in_sample.png")
# plt.show()
plt.close()
...
plt.ylabel("Value")
plt.legend()
plt.savefig("pics/prediction/noisy_sine_out_sample.png")
# plt.show()
plt.close()
...
# plt.ylabel("Value")
# plt.legend()
# plt.savefig("pics/prediction/sine_wave_one_prediction.png")
# # plt.show()
# plt.close()
...
# plt.ylabel("Value")
# plt.legend()
# plt.savefig("pics/prediction/sine_wave_two_prediction.png")
# # plt.show()
# plt.close()